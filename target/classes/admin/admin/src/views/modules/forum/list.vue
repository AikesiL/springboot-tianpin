    ...
    <div class="main-content">
        ...
        <template v-if="showFlag">
            <el-form class="center-form-pv" :style='{"width":"90%","margin":"0 auto 20px"}' :inline="true"
                ...
                <el-row :style='{"margin":"20px 0","display":"flex"}'>
                    <el-button
                            ...
                            v-if="isAuth('forum','新增')" type="success" @click="addOrUpdateHandler()">新增
                    </el-button>
                    <el-button
                            :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(222, 239, 255, 1)","width":"auto","fontSize":"14px","height":"40px"}'
                            v-if="isAuth('forum','删除')" :disabled="dataListSelections.length <= 0" type="danger"
            ...
            <el-table class="tables"
                      :stripe='true'
                      :style='{"padding":"0","borderColor":"#e4e3f4","margin":"0 0 20px","borderRadius":"5px","borderWidth":"1px 0 0 1px","background":"rgba(255,255,255,1)","width":"calc(100% - 0px)","borderStyle":"solid"}'
                ...
                <el-table-column width="300" label="操作">
                    <template slot-scope="scope">
                        <el-button
								...
								v-if="!forumChild &&  isAuth('forum','查看')" type="success" size="mini"
                                @click="addOrUpdateHandler(scope.row.id,'info')">详情
                        </el-button>
                        <el-button
								:style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(230, 242, 254, 1)","width":"auto","fontSize":"14px","height":"32px"}'
								v-if="!forumChild &&  isAuth('forum','修改')" type="primary" size="mini"
                        ...
                        <el-button
								:style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(230, 242, 254, 1)","width":"auto","fontSize":"14px","height":"32px"}'
								v-if="!forumChild" type="success" size="mini" @click="search(scope.row.id,'child')">查看评论
                        </el-button>


                        <el-button
								:style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(230, 242, 254, 1)","width":"auto","fontSize":"14px","height":"32px"}'
								v-if="isAuth('forum','删除') " type="danger" size="mini"
