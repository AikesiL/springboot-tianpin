            ...
            <el-form class="center-form-pv" :style='{"width":"90%","margin":"0 auto 20px"}' :inline="true"
                ...
                <el-row :style='{"margin":"20px 0","display":"flex"}'>
                    <el-button
                            ...
                            v-if="isAuth('messages','新增')" type="success" @click="addOrUpdateHandler()">新增
                    </el-button>
                    <el-button
                            :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(222, 239, 255, 1)","width":"auto","fontSize":"14px","height":"40px"}'
                            v-if="isAuth('messages','删除')" :disabled="dataListSelections.length <= 0" type="danger"
                ...
                <el-table-column :resizable='true' :sortable='false' prop="cpicture" width="200" label="留言图片">
                    <template slot-scope="scope">
                        <div v-if="scope.row.cpicture">
                            <img v-if="scope.row.cpicture.substring(0,4)=='http'"
                                 :src="scope.row.cpicture.split(',')[0]" width="100" height="100">
                ...
                <el-table-column :resizable='true' :sortable='false' prop="rpicture" width="200" label="回复图片">
                    <template slot-scope="scope">
                        <div v-if="scope.row.rpicture">
                            <img v-if="scope.row.rpicture.substring(0,4)=='http'"
                                 :src="scope.row.rpicture.split(',')[0]" width="100" height="100">
                ...
                <el-table-column width="300" label="操作">
                    <template slot-scope="scope">
                        <el-button
                                ...
                                v-if=" isAuth('messages','查看')" type="success" size="mini"
                                @click="addOrUpdateHandler(scope.row.id,'info')">详情
                        </el-button>
                        <el-button
                                :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(230, 242, 254, 1)","width":"auto","fontSize":"14px","height":"32px"}'
                                v-if=" isAuth('messages','修改')" type="primary" size="mini"
                        ...
                        <el-button
                                :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(230, 242, 254, 1)","width":"auto","fontSize":"14px","height":"32px"}'
                                v-if="isAuth('messages','回复')" type="primary" size="mini"
                                @click="addOrUpdateHandler(scope.row.id)">回复
                        </el-button>
                        <el-button
                                :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(230, 242, 254, 1)","width":"auto","fontSize":"14px","height":"32px"}'
                                v-if="isAuth('messages','删除') " type="danger" size="mini"
