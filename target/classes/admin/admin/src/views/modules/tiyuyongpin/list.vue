<template>
    <div class="main-content">
            ...
            <el-form class="center-form-pv" :style='{"width":"90%","margin":"0 auto 20px"}' :inline="true"
                ...
                <el-row :style='{"display":"block"}'>
                    <div :style='{"margin":"0 30px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","textAlign":"center","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}'
                               class="item-label">甜品名称</label>
                        <el-input v-model="searchForm.yongpinmingcheng" placeholder="甜品名称" clearable></el-input>
                    </div>
                    <div :style='{"margin":"0 30px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","textAlign":"center","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}'
                               class="item-label">口味</label>
                        <el-input v-model="searchForm.pinpai" placeholder="口味" clearable></el-input>
                    </div>
                    <div :style='{"margin":"0 30px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","textAlign":"center","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}'
                               class="item-label">店铺名称</label>
                        <el-input v-model="searchForm.dianpumingcheng" placeholder="店铺名称" clearable></el-input>
                    </div>
                    <div :style='{"margin":"0 30px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","textAlign":"center","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}'
                               class="item-label">价格</label>
                ...
                <el-row :style='{"margin":"20px 0","display":"flex"}'>
                    <el-button
                            ...
                            v-if="isAuth('tiyuyongpin','新增')" type="success" @click="addOrUpdateHandler()">新增
                    </el-button>
                    <el-button
                            :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(222, 239, 255, 1)","width":"auto","fontSize":"14px","height":"40px"}'
                            v-if="isAuth('tiyuyongpin','删除')" :disabled="dataListSelections.length <= 0" type="danger"
                    ...
                    <el-button
							:style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(222, 239, 255, 1)","width":"auto","fontSize":"14px","height":"40px"}'
							v-if="isAuth('tiyuyongpin','库存图表')" type="warning" @click="chartDialog2()">库存图表
                    </el-button>
                </el-row>
            </el-form>
                ...
                <el-table-column :resizable='true' :sortable='false' prop="yongpintupian" width="200" label="甜品图片">
                    <template slot-scope="scope">
                        <div v-if="scope.row.yongpintupian">
                            <img v-if="scope.row.yongpintupian.substring(0,4)=='http'"
                                 :src="scope.row.yongpintupian.split(',')[0]" width="100" height="100">
                ...
                <el-table-column width="300" label="操作">
                    <template slot-scope="scope">
                        <el-button
                                ...
                                v-if=" isAuth('tiyuyongpin','查看')" type="success" size="mini"
                                @click="addOrUpdateHandler(scope.row.id,'info')">详情
                        </el-button>
                        <el-button
                                :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(230, 242, 254, 1)","width":"auto","fontSize":"14px","height":"32px"}'
                                v-if=" isAuth('tiyuyongpin','修改')" type="primary" size="mini"
                        ...
                        <el-button
                                :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(230, 242, 254, 1)","width":"auto","fontSize":"14px","height":"32px"}'
                                v-if="isAuth('tiyuyongpin','查看评论')" type="primary" size="mini"
                                @click="disscussListHandler(scope.row.id)">查看评价
                        </el-button>


                        <el-button
                                :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(230, 242, 254, 1)","width":"auto","fontSize":"14px","height":"32px"}'
                                v-if="isAuth('tiyuyongpin','删除') " type="danger" size="mini"
        ...
        <el-dialog
                ...
                width="800">
            <div id="zulinzhuangtaiChart1" style="width:100%;height:600px;"></div>
        ...
        methods: {
            ...
            chartDialog2() {
                ...
                this.$nextTick(() => {
                    ...
                    var dingdanjineChart1 = echarts.init(document.getElementById("zulinzhuangtaiChart1"), 'macarons');
                    this.$http({
                        url: `tiyuyongpin/tongji`,
                        method: "get",
                    }).then(({data}) => {
                        if (data && data.code === 0) {
                            let res = data.data;
                            let xAxis = Object.keys(res);
                            let yAxis = Object.values(res);
                            let pArray = []
